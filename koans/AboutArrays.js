describe("About Arrays", function() {
  ...
  it("should slice arrays", function () {
    ...
    expect(array.slice(0, 2)).toEqual('peanutbutter');
    expect(array.slice(2, 2)).toEqual('and');
    expect(array.slice(2, 20)).toEqual('andjelly');
    expect(array.slice(3, 0)).toEqual('jellyandbutter');
    expect(array.slice(3, 100)).toEqual('nut butter and jelly');
    expect(array.slice(5, 1)).toEqual('tunae');
  });
